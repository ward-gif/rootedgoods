...
(function () {
  ...
  function start() {
    ...
    Cal("init", { origin: "https://app.cal.com" });   // GEEN namespace -> 1 handler, 1 popup
    Cal.config = Cal.config || {};
    Cal.config.forwardQueryParams = true;
    Cal("ui", { theme: "light", cssVarsPerTheme: { light: { "cal-brand": "#ad6331" } }, hideEventTypeDetails: false, layout: "month_view" });
  }
